...
public class DialogErrorBindingImpl extends DialogErrorBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.btnOk, 2);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.errorMessage == variableId) {
            setErrorMessage((java.lang.String) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setErrorMessage(@Nullable java.lang.String ErrorMessage) {
    ...
    protected void executeBindings() {
        ...
        java.lang.String errorMessage = mErrorMessage;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.errorText, errorMessage);
        }
    }
