...
import com.example.rickandmorty.local.dao.CharacterDao_Impl;
...
public final class RickAndMortyOffline_Impl extends RickAndMortyOffline {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `CharacterEntity` (`id` INTEGER NOT NULL, `name` TEXT NOT NULL, `imageURL` TEXT, `status` TEXT NOT NULL, `gender` TEXT NOT NULL, PRIMARY KEY(`id`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '202e016411291e1155bef163d052d9fa')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsCharacterEntity.put("imageURL", new TableInfo.Column("imageURL", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCharacterEntity.put("status", new TableInfo.Column("status", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCharacterEntity.put("gender", new TableInfo.Column("gender", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoCharacterEntity.equals(_existingCharacterEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "CharacterEntity(com.example.rickandmorty.local.entity.CharacterEntity).\n"
                  + " Expected:\n" + _infoCharacterEntity + "\n"
                  + " Found:\n" + _existingCharacterEntity);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "202e016411291e1155bef163d052d9fa", "c958d2fe075eb08d204f787c9e34b8a5");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "CharacterEntity");
  }
